...
ws.onmessage = function (event) {
  ...
  if (received_msg.hasOwnProperty("viewers")){
    document.getElementById("viewer_count").textContent = received_msg["viewers"];
    return
  }
...
//     buttons[i].onclick = function () {
//       let content = document.getElementsByTagName('input')[input_number].value;
//       ws.send((button_id + ":" + "abs_move:" + content));
//     };
//   }
//
//   console.log("i, j = " + i + " | " + input_number);
//   // the rel minus button
//     i++;
//     input_number++;
//   console.log("i, j = " + i + " | " + input_number);
//     buttons[i] = document.getElementsByTagName('Button')[i];
...
//     buttons[i].onclick = function () {
//       let content = document.getElementsByTagName('input')[input_number].value;
//       ws.send((button_id + ":" + "rel_move:" + content));
//     };
//   }
//   // the rel plus button
//     i++;
